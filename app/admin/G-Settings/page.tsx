...
export default function AdminSettingsPage() {
  const accountSettings: SettingsItem[] = [
    { label: 'Account details', icon: <FaCogs />, url: 'https://example.com/account/details' },
    { label: 'Account access management', icon: <FaUserCog />, url: 'https://example.com/account/access' },
    { label: 'Account change history', icon: <FaHistory />, url: 'https://example.com/account/history' },
    { label: 'API quota history', icon: <FaChartBar />, url: 'https://example.com/account/api' },
    { label: 'Trash', icon: <FaTrash />, url: 'https://example.com/account/trash' },
  ];

  const propertySettings: SettingsItem[] = [
    { label: 'Property details', icon: <FaCogs />, url: '/admin/property' },
    { label: 'Access management', icon: <FaUserCog />, url: '/admin/property/access' },
    { label: 'Change history', icon: <FaHistory />, url: '/admin/property/history' },
    { label: 'Quota usage', icon: <FaChartBar />, url: '/admin/property/quota' },
  ...
  const dataCollection: SettingsItem[] = [
    ...
    { label: 'Collection settings', icon: <FaDatabase />, url: '/admin/datacollection' },
    { label: 'Import data', icon: <FaArrowAltCircleUp />, url: '/admin/import' },
    { label: 'Retention settings', icon: <FaSlidersH />, url: '/admin/retention' },
  ...
  const dataDisplay: SettingsItem[] = [
    ...
    { label: 'Custom definitions', icon: <FaCodeBranch />, url: '/admin/definitions' },
  ...
  const productLinks: SettingsItem[] = [
    { label: 'Google AdSense links', icon: <SiGoogleads className="text-[#fbbc05]" />, url: 'https://adsense.google.com/' },
    { label: 'Google Ads links', icon: <SiGoogleads className="text-[#4285f4]" />, url: 'https://ads.google.com/' },
    { label: 'Ad Manager links', icon: <SiAdguard className="text-[#34a853]" />, url: 'https://admanager.google.com/' },
    { label: 'BigQuery links', icon: <SiGooglebigquery className="text-[#4285f4]" />, url: 'https://console.cloud.google.com/bigquery' },
    { label: 'Display & Video 360', icon: <SiGoogledisplayandvideo360 className="text-[#34a853]" />, url: 'https://dv360.google.com/' },
    { label: 'Floodlight', icon: <SiGoogletagmanager className="text-[#ea4335]" />, url: 'https://tagmanager.google.com/' },
    { label: 'Merchant Center', icon: <SiGooglemarketingplatform className="text-[#34a853]" />, url: 'https://merchants.google.com/' },
    { label: 'Google Play links', icon: <FaGooglePlay className="text-[#0f9d58]" />, url: 'https://play.google.com/console' },
    { label: 'Search Ads 360', icon: <SiGooglemarketingplatform className="text-[#34a853]" />, url: 'https://searchads.google.com/' },
    { label: 'Search Console', icon: <SiGooglesearchconsole className="text-[#ea4335]" />, url: 'https://search.google.com/search-console' },
  ];
    ...
    <AdminAuthGuard>
      <div className="flex min-h-screen bg-[#f8f9fa]">
        ...
        <main className="flex-1 px-6 sm:px-10 py-6">
          <motion.h1 {...cardAnimation} className="text-3xl font-bold text-[#202124] mb-2">
            Admin Settings
          </motion.h1>
          <div className="w-20 h-1 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full mb-8" />

          <p className="text-sm text-[#5f6368] mb-8">
            These settings apply to all users of this account and property. For settings that apply only to you, go to{' '}
            <span className="text-blue-600 cursor-pointer hover:underline">My preferences</span> in the left navigation.
          </p>

          <section className="mb-12">
            <h2 className="text-[12px] text-[#5f6368] font-medium tracking-wide mb-3 uppercase">Account Settings</h2>
            <GridCard
              title="Account"
          ...
          <section className="mb-16">
            <h2 className="text-[12px] text-[#5f6368] font-medium tracking-wide mb-3 uppercase">Property Settings</h2>
          ...
          <footer className="text-sm text-[#5f6368] border-t border-[#dadce0] pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-y-4">
            ...
            <div className="space-x-6">
              <span className="text-blue-600 cursor-pointer hover:underline">Analytics Home</span>
              <span className="text-blue-600 cursor-pointer hover:underline">Terms</span>
              <span className="text-blue-600 cursor-pointer hover:underline">Privacy</span>

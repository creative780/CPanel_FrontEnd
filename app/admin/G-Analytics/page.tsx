      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <main className="flex-1 px-6 py-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-5">
            <h1 className="text-2xl font-semibold text-gray-800 mb-2 sm:mb-0">Analytics Dashboard</h1>
            <button className="px-4 py-2 text-sm font-medium text-white bg-[#891F1A] hover:bg-[brown] rounded-md transition-all shadow">
              Download Report
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
            <AnalyticsOverviewCard title="Active Users" value="1" change="+12%" />
            <AnalyticsOverviewCard title="Event Count" value="144" change="+8%" />
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6"> {/* This is the parent div */}
            ...
            <div className="bg-white border border-gray-200 rounded-md p-4 shadow-sm flex flex-col min-h-[360px]">
              ...
              <div className="mb-4">
                <p className="text-xs text-gray-500 mb-1 text-[#891F1A]">Active Users Per Minute</p>
              ...
              <div className="text-right mt-auto pt-4">
                <button className="text-sm text-[#891F1A] hover:underline">View Realtime</button>
              </div>
            </div>
            {/* END Real-time Users Card */}
          </div> {/* This is the correct closing div for "Line Chart + Realtime Activity" grid */}
          ...
          <div className="mb-12 w-full relative">
            ...
            <div className="flex items-center justify-between px-6 mb-4">
              <h2 className="text-lg font-semibold text-[#891F1A]">Recently accessed</h2>
              <button className="text-sm text-[#891F1A] hover:underline">View All</button>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-2 text-blue-600 mb-2">
                      ...
                      <svg
                        ...
                        viewBox="0 0 24 24"
                      >
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 10h16M4 14h16" style={{color: '#891F1A'}} />
                      </svg>
                      <span className="text-sm font-medium text-[#891F1A]">{item.name}</span>
                    </div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-sm font-medium text-gray-700">Suggested for You</h2>
              <button className="text-xs text-[#891F1A] hover:underline">View All Insights</button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {/* Card 1: New Users by Source */}
              <div className="bg-white border border-gray-200 rounded-md p-4 shadow-sm">
                <h3 className="text-xs font-semibold text-gray-600 uppercase mb-3">New users by <br /> First user source</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-md p-4 shadow-sm relative">
                <h3 className="text-xs font-semibold text-gray-600 uppercase mb-3">
                  Active users <span className="normal-case">by Country ID</span>
                </h3>
                ...
                <div className="relative w-full h-36 bg-gray-100 rounded mb-4 overflow-hidden flex items-center justify-center">
                  ...
                  <div className="absolute bottom-2 left-2 bg-white text-xs text-gray-700 shadow-md rounded-md p-3 border border-gray-200 w-fit">
                    ...
                    <div className="flex items-center gap-2">
                      <img src="/images/pk-flag.png" alt="Pakistan Flag" className="w-4 h-4 rounded-sm" />
                      <span className="font-medium text-gray-800">Pakistan</span>
                      <span className="ml-auto font-semibold text-gray-900">1</span>
                    </div>
                  </div>
                </div>
                ...
                <table className="w-full text-sm text-gray-700">
                  ...
                  <tbody>
                    <tr>
                      <td className="py-1 text-[#891F1A] font-semibold">Pakistan</td>
                      <td className="text-right py-1">1</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div className="mt-3 flex justify-between text-xs text-gray-400">
                  ...
                  <a href="#" className="text-[#891F1A] hover:underline">View countries</a>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-md p-4 shadow-sm">
                <h3 className="text-xs font-semibold text-gray-600 uppercase mb-3">Views by <br /> Page title and screen</h3>
                <table className="w-full text-sm text-gray-700">
                  <thead>
                    <tr className="border-b text-xs text-gray-500">
                  ...
                  <tbody>
                    <tr>
                      <td className="py-1 truncate" title="404: This page could not be found">404: This page could...</td>

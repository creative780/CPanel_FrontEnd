...
const team = [
  {
    name: 'Muhammad Mehrban Malik',
    title: 'Founder & Chairman',
    image: '/images/mehrban.png',
  },
  {
    name: 'Yasir Malik',
    title: 'CEO',
  ...
  {
    name: 'Rizwan Malik',
    title: 'Production Head / Art Director',
...
const AboutPage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <LogoSection/>
      <MobileTopBar />
      <main className="flex-grow px-4 md:px-16 py-12 text-gray-800">
        ...
        <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24" data-aos="fade-up">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 leading-tight mb-4" data-aos="fade-left">
              A legacy built on <span style={{ color: '#891F1A' }}>performance</span> and trust
            </h2>
            <p className="text-gray-600 text-lg" data-aos="fade-left" data-aos-delay="200">
        ...
        <section className="relative max-w-5xl mx-auto mb-24 px-6 py-12 bg-[#E7D2D1] rounded-3xl shadow-lg text-center overflow-hidden" data-aos="zoom-in">
          ...
          <div className="mt-6">
            <button className="inline-block bg-[#891F1A] text-white font-semibold px-6 py-3 rounded-full shadow-md hover:shadow-xl transition">
            ...
            <svg width="200" height="200" fill="none">
              ...
              <defs>
                <linearGradient id="gradient" x1="0" y1="0" x2="200" y2="200" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#891F1A" />
                  <stop offset="1" stopColor="#891F1A" />
                </linearGradient>
              </defs>
            </svg>
          </div>
        ...
        <section className="bg-[#E7D2D1] rounded-3xl px-6 md:px-14 py-16 mb-20 shadow-xl">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-12 leading-relaxed">
              Creative Connect Advertising was born from the vision of <strong>Malik Muhammad Mehrban</strong>, a trailblazer in the printing world.
            ...
            <div className="mt-16 bg-[#891F1A] rounded-xl text-white px-8 py-10">
              <h3 className="text-2xl font-bold mb-2">Let’s Print the Future Together</h3>
              <p className="text-white/90 mb-4">
                Whether you're a startup or enterprise, we’ll bring your ideas to life. Fast. Custom. Reliable.
              </p>
              <button className="mt-2 px-6 py-2 bg-white font-semibold rounded-full shadow hover:shadow-lg transition" style={{ color: '#891F1A' }}>
                Contact Us Today
              </button>
            </div>
          </div>
            ...
            >
              ...
              <div className="h-[180px] flex items-end justify-center mb-4">
                <Image
                  ...
                  priority={index < 2} // Prioritize top few
                />
              </div>
        ...
        <section className="max-w-6xl mx-auto py-20 px-4 text-center">
          <h2 className="text-4xl font-extrabold text-gray-900 mb-12">Our Vision, Mission & Values</h2>
          <div className="grid md:grid-cols-3 gap-10 text-left">
            {[
              ...
              { icon: '💎', title: 'Core Values', color: 'purple', text: '', list: ['Customer-Centric', 'Innovation-Driven', 'Eco-Responsible', 'Integrity & Excellence'] },
            ].map((item, i) => (
              <div key={i} className={`bg-white p-6 rounded-2xl shadow-md hover:shadow-xl border border-${item.color}-100`}>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className={`text-xl font-semibold text-${item.color}-700 ml-3`}>{item.title}</h3>
                </div>
                {item.text && <p className="text-gray-700 leading-relaxed">{item.text}</p>}
                {item.list && (
        ...
        {/* Testimonials */}
        <section className="max-w-6xl mx-auto py-20 px-4 text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-12" data-aos="fade-up">What Our Clients Say</h2>
          <div className="grid md:grid-cols-3 gap-8" style={{ color: '#891F1A' }}>
            {[
              ...
              >
                ...
                <p className="text-gray-700 italic leading-relaxed mb-6">“{t.comment}”</p>
                <h4 className="font-semibold text-base" style={{ color: '#891F1A' }}>{t.name}</h4>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-[#E7D2D1] py-20 px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10" data-aos="fade-up">
